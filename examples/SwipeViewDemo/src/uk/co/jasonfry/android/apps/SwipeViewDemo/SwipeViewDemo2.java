...
public class SwipeViewDemo2 extends Activity
{
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		final PageControl mPageControl = (PageControl) findViewById(R.id.page_control);
		...
		final ImageView i0 = new ImageView(this);
		final ImageView i1 = new ImageView(this);
		...
		final SwipeImageLoader mSwipeImageLoader = new SwipeImageLoader();
	...
	private class SwipeImageLoader implements OnPageChangedListener
	{
		...
		public void onPageChanged(final int oldPage, final int newPage)
		{
			if(newPage>oldPage)//going forwards
			{
				...
				{
					final ImageView v = new ImageView(SwipeViewDemo2.this);
