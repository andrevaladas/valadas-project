package com.chronosystems.pulltorefresh.library.internal;
...
import com.chronosystems.pulltorefresh.library.PullToRefreshBase;
import com.chronosystems.pulltorefresh.library.R;
...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(final Context context, final int mode, final TypedArray attrs) {
		super(context);
		final ViewGroup header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header, this);
