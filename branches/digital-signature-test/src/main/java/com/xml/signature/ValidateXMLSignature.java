...
public class ValidateXMLSignature {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	final String xmlFilePath = ClassLoader.getSystemResource("envelope.xml").getPath(); 

        validateSignature(xmlFilePath);
    }

    public static void validateSignature(final File xmlFile) throws Exception {
    ...
    public static void validateSignature(final String xmlFilePath) throws Exception {
    	// Instantiate the document to be validated
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        dbf.setNamespaceAware(true);
    ...
    private static void validateSignature(Document doc) throws Exception {
