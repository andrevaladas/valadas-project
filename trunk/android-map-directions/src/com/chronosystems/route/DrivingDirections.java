...
public abstract class DrivingDirections
{
	 ...
	 */
	public void driveTo (final GeoPoint startPoint, final GeoPoint endPoint, final Mode mode, final IDirectionsListener listener)
	{
	...
	protected void onDirectionsAvailable (final Route route)
	{
		if (listener != null) {
