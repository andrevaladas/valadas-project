...
public class JavaUtil {
  ...
  public static boolean doValida (String parametro) {
    return parametro != null
        ...
        && !"undefined".equals (parametro.trim ().toLowerCase ())
        && !"null".equals (parametro.trim ().toLowerCase ());
  }

  public static boolean doValidaData(String parametro) {
	 return doValida(parametro) && !"//".equals(parametro);
  }
  ...
  public static String getSQLStringDefOL (String string , String defaultValue) {
	    return !doValida(string) ?  defaultValue  :  string ;
  }
