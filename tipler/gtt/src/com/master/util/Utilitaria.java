...
public class Utilitaria extends Transacao {
    ...
    /**
     * Retorna da session o tipo de empresa do usuario logado.
     * T = Tipler
     * C = Concessionaria
     * U = Cliente usuario final
     */
    
    public static String getTipoEmpresa(HttpServletRequest request) throws Excecoes {
    	UsuarioED usuED = (UsuarioED)request.getSession(true).getAttribute("usuario");
    	return (usuED.getDm_Tipo_Empresa());
    }
