...
public class FormataData {
	private static final String FORMATO_DATA_MES_ANO_TELA = "MM/yyyy";
	...
	public static String formataDataMesAnoBT(java.sql.Date data) {
		if (data != null) {
			SimpleDateFormat formatter = new SimpleDateFormat(FORMATO_DATA_MES_ANO_TELA);
			return formatter.format(data);
		} else {
			return "";
		}
	}
	public static String formataDataMesAnoBT(String data) {
		if (JavaUtil.doValida(data)) {
			java.sql.Date sqlDate = java.sql.Date.valueOf(data);
			return formataDataBT(sqlDate);
		} else {
