...
public class PneuED extends RelatorioBaseED{
	...
	transient double nr_Km_No_Veiculo;
	 ...
	 */
	public PneuED(int oid_Pneu,
				  String CD_Pneu,
				  String NR_Fabrica,
				  int oid_Fabricante_Pneu,
				  String CD_Fabricante_Pneu,
				  String NM_Fabricante_Pneu,
				  int oid_Modelo_Pneu,
				  String CD_Modelo_Pneu,
				  String NM_Modelo_Pneu,
				  String DM_Localizacao,
				  String DM_Situacao,
				  String DM_Posicao,
				  int KM_Atual,
				  double MM_Atual,
	...
	public void setDm_Garantia_Ultima_Recapagem(boolean dm_Garantia_Ultima_Recapagem) {
	...
	public void setNm_Garantia_Ultima_Recapagem(String nm_Garantia_Ultima_Recapagem) {
	...
	public void setNr_MM_Sulco_Ultima_Recapagem(double nr_MM_Sulco_Ultima_Recapagem) {
	...
	public String getDesc_Eixo() {
		...
		if ("B".equals(this.getDm_Eixo())){
			nm = "B - Tração";
		}else	
		if ("C".equals(this.getDm_Eixo())){
			nm = "C - Truck";
		}else	
		if ("D".equals(this.getDm_Eixo())){
			nm = "D - 1º Eixo";
		}else	
		if ("E".equals(this.getDm_Eixo())){
			nm = "E - 2º Eixo";			
		}else
		if ("F".equals(this.getDm_Eixo())){
			nm = "F - 3º Eixo";
		}else	
		if ("G".equals(this.getDm_Eixo())){
			nm = "G - 4º Eixo";
		}else	
		if ("S".equals(this.getDm_Eixo())){
			nm = "Estepe";
		}
		else{	
	...
	public double getNr_Km_No_Veiculo() {
		return nr_Km_No_Veiculo;
	}


	public void setNr_Km_No_Veiculo(double nrKmNoVeiculo) {
		nr_Km_No_Veiculo = nrKmNoVeiculo;
	}
	...
	public void setNm_Tipo_Veiculo(String nmTipoVeiculo) {
		nm_Tipo_Veiculo = nmTipoVeiculo;
	}
	...
	public void setOid_Tipo_Veiculo(long oidTipoVeiculo) {
		oid_Tipo_Veiculo = oidTipoVeiculo;
	}
