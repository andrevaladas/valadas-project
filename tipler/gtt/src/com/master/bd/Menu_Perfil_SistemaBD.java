...
public class Menu_Perfil_SistemaBD extends BancoUtil {
	...
	public ArrayList lista(Menu_Perfil_SistemaED ed) throws Excecoes {
		...
		try {
			...
			while (res.next()) {
				list.add(populaRegistro(res,ed.isIdentado(),ed.getDm_Lingua()));
			}
			return list;
	...
	private Menu_Perfil_SistemaED populaRegistro(ResultSet res, boolean identado,String dmLingua) throws SQLException, Excecoes {
		String brancos = "               ";
