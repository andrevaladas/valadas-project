...
set CATALINA_HOME=C:\Program Files\OpenLaszlo Server 4.0.3\Server\tomcat-5.0.24
set CATALINA_BASE=C:\Program Files\OpenLaszlo Server 4.0.3\Server\tomcat-5.0.24
