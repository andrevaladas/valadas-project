...
return this.context_=CanvasRenderingContext2D_.make(this)
}
...
var $5=CanvasGradient_.make("gradient")
return $5
}
$5.createRadialGradient=function($1,$2,$3,$4,$5,$6){
var $7=CanvasGradient_.make("gradientradial")
$7.radius1_=$3
$7.radius2_=$6
$7.focus_.x=$1
$7.focus_.y=$2
