package com.chronosystems.library.horzscroll;
...
public class MyHorizontalScrollView extends HorizontalScrollView {
	public MyHorizontalScrollView(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public MyHorizontalScrollView(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 */
	public void initViews(final View[] children, final int scrollToViewIdx, final SizeCallback sizeCallback) {
		...
		final OnGlobalLayoutListener listener = new MyOnGlobalLayoutListener(parent, children, scrollToViewIdx, sizeCallback);
	...
	class MyOnGlobalLayoutListener implements OnGlobalLayoutListener {
		 ...
		 *            A SizeCallback to interact with the HSV.
		 */
		public MyOnGlobalLayoutListener(final ViewGroup parent, final View[] children, final int scrollToViewIdx, final SizeCallback sizeCallback) {
			this.parent = parent;
